      ...
      body: Padding(padding: EdgeInsets.fromLTRB(30.0, 40.0, 30.0, 0.0),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Name:', style: TextStyle(color: Colors.black54, fontSize: 24, letterSpacing: 2.0, fontWeight: FontWeight.w800 ),
            ),
            Text('$_userName', style: TextStyle(color: Colors.cyan, fontSize: 30, letterSpacing: 2.0),
            ),

            SizedBox(height: 30.0),
            Text('E-mail:', style: TextStyle(color: Colors.black54, fontSize: 24, letterSpacing: 2.0, fontWeight: FontWeight.w800 ),
            ),
